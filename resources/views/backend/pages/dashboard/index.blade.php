            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        <h4 class="page-title pull-left">Dashboard New</h4>
                    ...
                    <div class="card">
                        <div class="card-body bg1">
                            ...
                            <div class="testimonial-carousel owl-carousel">
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ asset('admin-assets/images/team/team-author1.jpg') }}">
                                    </div>
                                ...
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ asset('admin-assets/images/team/team-author2.jpg') }}">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
                                        <span class="profsn">Designer</span>
                                ...
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ asset('admin-assets/images/team/team-author3.jpg') }}">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
                                        <span class="profsn">Designer</span>
